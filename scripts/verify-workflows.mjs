...
for (const required of ["id: deploy", "tee \"$deployment_log\"", "PIPESTATUS[0]", "复核运行程序健康状态", "steps.deploy.outputs.runtime_url", "EXPECTED_POLICY_SHA", "健康接口字段集合不正确", "真实Cloudflare版本编号"]) {
