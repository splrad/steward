...
describe("中央命令入口", () => {
  ...
  it("审查说明迁移清单绑定新工作流内容", () => {
    expect(stewardReviewInstructionsTransitionFiles[".github/workflows/sync-review-instructions.yml"]).toBe("b3425ff5bc54a42316e501096ebfe46340956ac54398ff90cebb8e0f747a9a38");
  });
